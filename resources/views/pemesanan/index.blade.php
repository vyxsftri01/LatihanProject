											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-110px"><h6>Nama Pemesan</h6></th>
                                                        {{-- <th class="min-w-150px"><h6>Nama villas</h6></th> --}}
                                                        <th class="min-w-130px"><h6>Nama Villa</h6></th>
                                                        <th class="min-w-100px"><h6>Pesanan</h6></th>
                										<th class="min-w-100px"><h6>Lama Sewa</h6></th>
                                                        <th class="min-w-150px"><h6>Tanggal Masuk</h6></th>
                                                        <th class="min-w-150px"><h6>Tanggal Keluar</h6></th>
