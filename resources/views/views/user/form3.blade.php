...
<!-- <section class="ftco-section ftco-book ftco-no-pt ftco-no-pb"> -->
            <div class="container" >
                    <div class="row justify-content-center" style="background-image: url('{{asset('assetn/images/bcl.jpg')}}');" data-stellar-background-ratio="0.5">
                            ...
                            @csrf
							<h3 class="mb-3" style="font-color: light;">Kritik dan saran</h3>
							<div class="row">
								<div class="col-md-12">
                                ...
                                <div class="col-md-12">
									<div class="form-group">
			    					<input type="text" class="form-control @error('pesan') is-invalid @enderror" placeholder="Pesan"
									name="pesan">
									@error('pesan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
								...
								<div class="col-md-12">
									<div class="form-group">
			              <input type="submit" value="Kirim" class="btn btn-primary py-3 px-4">
			            </div>
								</div>
							</div>
	    			</form>
