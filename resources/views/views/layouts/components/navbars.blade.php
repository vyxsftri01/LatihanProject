	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse"  id="ftco-nav">
	        <ul class="navbar-nav ml-auto" >
	        	...
	        	<li class="nav-item"><a bouncesref="{{url('villaroom')}}" class="nav-link">Villa</a></li>

	        </ul>
            <div class="app-navbar-item ms-1 ms-lg-3" id="kt_bounceseader_user_menu_toggle" >
									<!--begin::Menu wrapper-->
									<div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attacbounces="parent" data-kt-menu-placement="bottom-end" >
