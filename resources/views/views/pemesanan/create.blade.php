                    ...
                    <div class="row justify-content-center" style="background-image: url('{{asset('assetn/images/bgndclr.jpg')}}');" data-stellar-background-ratio="0.5">
							...
							<div class="row">
								<div class="col-md-12">
			    					...
			    					<input type="text" class="form-control  @error('no') is-invalid @enderror" placeholder="Kode" 
									name="no">
									@error('no')
								 ...
								 <div class="form-group">
			    				  <div class="input-wrap">
			            		   <div class="icon"><span class="ion-md-calendar"></span></div>
                                        <select name="nama_villa" class="form-control @error('nama_villa') is-invalid @enderror"
                                            id="">
                                ...
                                <div class="col-md-12">
									<div class="form-group">
			    					<input type="number" class="form-control @error('lama') is-invalid @enderror" placeholder="Lama Sewa"
									name="lama">
									@error('lama')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
								...
								<div class="col-md-12">
								 <div class="form-group">
			    				  <div class="input-wrap">
			            		   <div class="icon"><span class="ion-md-calendar"></span></div>
			            		    <input type="date" class="form-control @error('tgl_masuk') is-invalid @enderror" placeholder="Tanggal Masuk"
                                        name="tgl_masuk">
                                        @error('tgl_masuk')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-12">
			    					...
			    					<div class="input-wrap">
			            		<div class="icon"><span class="ion-md-calendar"></span></div>
			            		<input type="date" class="form-control @error('tgl_keluar') is-invalid @enderror" placeholder="Tanggal Keluar"
								name="tgl_keluar">
								@error('tgl_keluar')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
