							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									...
									<div class="card card-flush">
										<!--begin::Card header-->
										<div class="card-header align-items-center py-3 gap-2 gap-md-3">
											<!--begin::Card title-->
                                            ...
                                            <div class="card-toolbar">
												<!--begin::Add customer-->
												<a href="{{ route('identitas.create') }}" class="btn btn-primary">Create</a>
												<!--end::Add customer-->
											</div>
											<!--end:
											<!--end::Card title-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-100px"><h6>Kode</h6></th>
														<th class="min-w-100px"><h6>Nama</h6></th>
                                                        <th class="min-w-100px"><h6>Alamat</h6></th>
                										<th class="min-w-100px"><h6>Tanggal Lahir</h6></th>
                                                        <th class="min-w-100px"><h6>Jenis Kelamin</h6></th>
                                                        <th class="min-w-120px"><h6>No Tlp</h6></th>
                                                        <th class="min-w-120px"><h6>No Ktp</h6></th>
