...
@section('content')
    <section class="ftco-section bg-light">
			<div class="container">
	          ...
	          <div class="pl-md-5">
				            <h1 style = "font-family:courier,arial,helvetica;">{{ $villa->jenis_villa }}</h1>
							<p><strong>Detail Kelengkapan:</strong></p>
							<div class="row">
                            <div class="text p-4 p-xl-5 text-center">
    							<h3><p class="star mb-0"><span class="fa fa-star" style="color:rgb(201, 175, 126);"></span><span class="fa fa-star" style="color:rgb(201, 175, 126);"></span><span class="fa fa-star" style="color:rgb(201, 175, 126);"></span><span class="fa fa-star"style="color:rgb(201, 175, 126);"></span><span class="fa fa-star"></span></p></h3>
    							<!-- <p class="mb-0"><span class="price mr-1">$120.00</span> <span class="per">per night</span></p> -->
	    						<h2 class="mb-3"><a href="rooms.html" style="color:rgb(201, 175, 126);">{{ $villa->nama_villa }}</a></h2>
                                <h4 class="mb-3"><a href="rooms.html" style="color:rgb(201, 175, 126);">{{ $villa->harga }}</a></h4>
                                <h4>
									<ul class="list-accomodation">
	    							<li><span>Jumlah lantai:</span>{{ $villa->lantai }}</li>
	    							<li><span>Kamar Tidur:</span>{{ $villa->kamar }}</li>
									<li><span>Kamar Mandi:</span>{{ $villa->kamar_mandi }}</li>
									<li><span>Maksimal jumlah penghuni:</span>{{ $villa->max }}</li>	
	    							<li><span>View:</span> {{ $villa->view }}</li>
	    							<li><span>Bed:</span> {{ $villa->kasur }}</li>
	    						</ul>
                                </h4>
                                
	    						<p><a href="{{url('create')}}" class="btn" style="background-color:rgb(201, 175, 126);">Pesan sekarang </a></p>
    						</div>
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-9 text-center">
						...
						<p class="mb-0"><a href="{{url('villaroom')}}" class="btn px-4 py-3" style="background-color:rgb(201, 175, 126);">Lihat Lebih Banyak....</a> </p>
					</div>
				</div>
			</div>
		</section>
