									...
									<div class="card card-flush">
										...
										<div class="card-header align-items-center py-5 gap-2 gap-md-5">
											...
											<div class="card-toolbar">
												<!--begin::Add customer-->
												<a href="{{ route('tentang.create') }}" class="btn btn-primary">Create</a>
												<!--end::Add customer-->
											</div>
											<!--end::Card toolbar-->
										</div>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-100px"><h6>Judul</h6></th>
                                                        <th class="min-w-100px"><h6>Deskripsi</h6></th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form action="{{ route('tentang.destroy', $data->id) }}" method="post">
                                                                    ...
                                                                    <a href="{{ route('tentang.show', $data->id) }}"
