...
<div class="container" >
        <div class="row justify-content-center" style="background-image: url('{{asset('assetn/images/bgndclr.jpg')}}');" data-stellar-background-ratio="0.5">
                ...
                @csrf
							<h3 class="mb-3" style="font-color: light;">Isi Identitas Anda</h3>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
			    					<input type="number" class="form-control  @error('no_pengguna') is-invalid @enderror" placeholder="Kode Pengguna" 
									name="no_pengguna">
									@error('no_pengguna')
			            		...
			            		<input type="text" class="form-control @error('alamat') is-invalid @enderror" placeholder="Alamat"
								name="alamat">
								@error('alamat')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
			            		...
			            		<div class="icon"><span class="ion-md-calendar"></span></div>
			            		<input type="date" class="form-control @error('tgl_lahir') is-invalid @enderror" placeholder="Tanggal Lahir"
								name="tgl_lahir">
								@error('tgl_lahir')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
								...
								<div class="col-md-12">
									<div class="form-group">
			    					<input type="text" class="form-control @error('no_tlp') is-invalid @enderror" placeholder="No Tlp"
									name="no_tlp">
									@error('no_tlp')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
			            		...
			            		<input type="text" class="form-control @error('no_ktp') is-invalid @enderror" placeholder="No Ktp"
								name="no_ktp">
								@error('no_ktp')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
