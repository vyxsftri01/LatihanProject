											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-90px"><h6>Kode</h6></th>
														<th class="min-w-110px"><h6>Nama Villa</h6></th>
                                                        {{-- <th class="min-w-150px"><h6>Nama villas</h6></th> --}}
                                                        <th class="min-w-130px"><h6>Lama Sewa</h6></th>
                                                        <th class="min-w-100px"><h6>Pesanan</h6></th>
                										<th class="min-w-100px"><h6>Harga</h6></th>
                                                        <th class="min-w-150px"><h6>Total</h6></th>
                                                        <th class="min-w-150px"><h6>Bayar</h6></th>
                                                        <th class="min-w-100px"><h6>Kembali</h6></th>
												...
												<tbody class="fw-semibold text-gray-700">
                                                    ...
                                                    <hr>
                                                        <tr>
                                                            {{-- <td>{{ $no++ }}</td> --}}
                                                            <td>{{ $data->pemesanans->no }}</td>
                                                            <td>{{ $data->pemesanans->nama_villa }}</td>
                                                            <td>{{ $data->pemesanans->lama }}</td>
                                                            <td>{{ $data->pemesanans->jpesan }}</td>
                                                            <td>{{ $data->pemesanans->harga }}</td>
                                                            <td>{{ $data->transaksis->total }}</td>
                                                            <td>{{ $data->transaksis->bayar }}</td>
                                                            <td>{{ $data->pemesanans->sisa }}</td>
                                                            <td>
