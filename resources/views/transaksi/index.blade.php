											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-90px"><h6>Kode Pesanan</h6></th>
														<th class="min-w-130px"><h6>Nama </h6></th>
                                                        {{-- <th class="min-w-150px"><h6>Nama villas</h6></th> --}}
                                                        <th class="min-w-130px"><h6>villas</h6></th>
                                                        <th class="min-w-100px"><h6>Lama Sewa</h6></th>
                										<th class="min-w-110px"><h6>Harga Sewa</h6></th>
                                                        <th class="min-w-130px"><h6>Total</h6></th>
                                                        <th class="min-w-120px"><h6>Bayar</h6></th>
                                                        <th class="min-w-110px"><h6>Sisa</h6></th>
