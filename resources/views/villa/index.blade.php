											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
												...
												<thead>
													...
													<tr class="text-start text-dark-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-100px">Kode Villa</th>
                                                        <th class="min-w-100px">Nama Villa</th>
														<th class="min-w-100px">Jenis Villa</th>
                                                        <th class="min-w-140px">Foto Villa</th>
                										<th class="min-w-80px">Harga/malam</th>
